...
tutors = [
    ...
    'Дмитрий', 'Борис', 'Елена', 'Тор', 'Зевс', 'Суперкид'
]
klasses = [
    '9А', '7В', '9Б', '9В', '8Б', '10А', '10Б', '9А'
]
pupils = ((tutors, klasses) for tutors, klasses in itertools.zip_longest(tutors, klasses, fillvalue=None))
print(pupils)
print(*itertools.islice(pupils, len(tutors)), sep='\n')
